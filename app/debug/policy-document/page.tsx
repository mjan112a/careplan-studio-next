...
export default async function PolicyDocumentDebugPage({ searchParams }: Props) {
  ...
  try {
    logger.info('Fetching policy document details from API', { id });
  ...
  // If we have an error, display it but continue rendering whatever data we have
  if (error) {
    // Calculate file sizes from metadata if available
      ...
      <div className="max-w-7xl mx-auto p-8 space-y-8">
        ...
        <div className="bg-red-50 border border-red-300 text-red-800 p-4 rounded-lg">
          ...
          <ul className="list-disc ml-5">
            <li>Authentication issues (middleware rejecting the request)</li>
        ...
        {/* Show any data we were able to load */}
        {policy && (
          <div className="bg-white p-4 rounded-lg shadow border border-gray-200 mb-6">
            <h2 className="font-semibold mb-3">Document Summary (Partial Data)</h2>
